...
The [ZigBee Interface Specification](../sources/openwebnet-public/pdf/OpenWebNet_Zigbee.pdf), version 4.0, is also relevant to Protocol, Diagnostics, Programming boundaries, and functional `WHO 1`, `2`, `4`, `13`, `18`, and `25`. It describes a particular Legrand serial interface, not a universal replacement for the SCS-oriented references. The [ZigBee Interface](../protocol/zigbee-interface.md) owns cross-cutting transport, addressing, acknowledgement, and applicability; detailed ZigBee `WHO 13` management is integrated in [ZigBee Network Management](who-13-integration-gateway/zigbee-network-management.md), and detailed ZigBee `WHO 25` binding is integrated in [ZigBee Binding](who-25-transversal/zigbee-binding.md). Operation-level coverage of the other ZigBee functional namespaces remains incomplete. The source's publication status also requires the [Source Provenance Qualification](../sources/openwebnet-public/README.md). See the [Phase 3 Source-Coverage Audit](../project/review/phase-3-source-coverage.md) and [ZigBee Reconciliation Review](../project/review/zigbee-reconciliation.md) for inspection scope, source conflicts, and rejected exploratory claims.
