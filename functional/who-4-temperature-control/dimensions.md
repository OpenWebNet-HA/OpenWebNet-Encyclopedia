...
| `7` | Control/configuration operation represented in the MyHOME_Suite protocol data |
| `11` | Fan speed |
...
The MyHOME_Suite protocol data defines `DIMENSION 7` command templates for Temperature Control functions. The corresponding parameter definitions represent temperatures from 3–40 °C in 0.5 °C steps where that parameter definition applies.
