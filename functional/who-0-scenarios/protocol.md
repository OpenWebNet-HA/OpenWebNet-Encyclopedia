...
See [`../../scenario-engine/`](../../scenario-engine/) for the MyHOME_Suite trigger/condition/action capability model and [`../../protocol/`](../../protocol/) for common frame/session syntax.