...
This directory contains the canonical project-wide standards governing the OpenWebNet Encyclopedia.
...
Machine KB schema, serialization, validation, and generation requirements are separate from the ESG, while remaining subject to the ECV.
