...
5. Regenerate all impacted outputs through the shared IR with `python build.py`, then run `python check.py` and the applicable repository checks. CI must remain offline and model-free.
