...
| MKB-O06 | Partly resolved in 2 | ID registry schema, golden JSONL, reference names fixed; curated registry location and Markdown corpus format remain later decisions |
