...
**Next:** Phase 5 builds the manifest, deterministic rebuild comparison, and common build/check commands. Review guide remediation hints before generated corpus publication.
