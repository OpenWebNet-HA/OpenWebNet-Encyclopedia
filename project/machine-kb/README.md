...
**Next:** Phase 2 maps ECV evidence and uncertainty concepts to controlled vocabularies and implements common schemas, tests, and golden serialization fixtures against the Phase 1 contract. Those schemas must reuse the completed privacy metadata vocabulary. Do not populate outputs before their contract and privacy path are specified.
