...
The current pre-release build implements the consumer contract, schema vocabulary, privacy gate, shared IR, corpus, retrieval chunks, manifest, canonical reference registries, and an eight-claim framework sample. Broad claim population, full drift/change-impact analysis, release CI, candidate certification, and the initial released version remain gated work. See [Decisions](decisions.md) and [Roadmap](roadmap.md).
