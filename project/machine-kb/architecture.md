...
The current pre-release build implements the consumer contract, schema vocabulary, privacy gate, shared IR, corpus, retrieval chunks, manifest, canonical reference registries, the atomic-claim framework, and bounded claims for five canonical domains. Remaining claim domains, full drift/change-impact analysis, release CI, candidate certification, and the initial released version remain gated work. See [Decisions](decisions.md) and [Roadmap](roadmap.md).
