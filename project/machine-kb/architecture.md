...
The current pre-release build implements the consumer contract, schema vocabulary, privacy gate, shared IR, corpus, retrieval chunks, manifest, canonical reference registries, the atomic-claim framework, bounded claims for all eight canonical domains, cross-artifact consistency and change-impact checks, and offline release CI. Independent Phase 15 recertification passed for semantic candidate 5e5dda65b6ba8d5f4da2ec69126d4a9452455c50, and the final release checklist passed for release-content revision b1560324c0b5733614e8eb90cd4f9d04b96edfa9. Merge, tag, publication, and any released-v1 declaration remain gated on explicit authorization. See [Decisions](decisions.md), [Roadmap](roadmap.md), and [Release Gates and Consumer Contract Status](release.md).
