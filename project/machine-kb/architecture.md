...
The current pre-release build implements the consumer contract, schema vocabulary, privacy gate, shared IR, corpus, retrieval chunks, manifest, and canonical reference registries. Atomic claims, full drift/change-impact analysis, release CI, candidate certification, and the initial released version remain gated work. See [Decisions](decisions.md) and [Roadmap](roadmap.md).
