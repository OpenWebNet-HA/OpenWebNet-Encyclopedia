...
| MKB-R04 | Partially resolved | Release blocker | Shared parser/IR, deterministic manifest, and clean double-build gate pass; complete CI and cross-artifact checks remain | Complete Phases 12-13; CI must not call an LLM |
