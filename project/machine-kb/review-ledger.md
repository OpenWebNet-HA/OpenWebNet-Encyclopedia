...
| --- | --- | --- | --- | --- |
| MKB-R01 | Partially resolved through Phase 9 | Release blocker | Schemas, manifest, corpus, chunks, reference registries, the claim framework, and bounded `protocol/`/`functional/` claims are populated; other claim domains and later release machinery remain incomplete | Complete Phases 10-14 and validate candidate outputs |
