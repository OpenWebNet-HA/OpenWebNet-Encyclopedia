...
| MKB-R04 | Partially resolved | Release blocker | Shared parser/IR passes complete tree; no manifest, full rebuild gate, or complete CI yet | Complete Phases 5, 12-13; CI must not call an LLM |
