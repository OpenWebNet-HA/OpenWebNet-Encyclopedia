...
| MKB-R03 | Partially resolved | Release blocker | Phase 1 contract and versioning policy now defined; schemas, curated registry, fixtures, and released v1 interface absent | Implement and review Phase 2 schemas and registry before releasing records |
