...
Generated files belong in their audience-specific directory. The current public set is the LLM corpus, retrieval chunks, claims, reference registries, schemas, and manifest. Do not mix source documentation, canonical evidence files, or manually maintained protocol prose into this hierarchy.
